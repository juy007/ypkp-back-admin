...
<head>
	...
	<link href="{{ asset('assets/css/app.css') }}?v={{date('His');}}" rel="stylesheet">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="{{ url('gelombang') }}">
						...
						<div class="menu-title">Gelombang</div>
					</a>
				</li>
				<li>
					<a href="{{ url('jurusan') }}">
				...
				<li>
					...
					<ul>
						<li> <a href="{{ url('setting-facebook-pixel') }}"><i class="bx bx-code-block"></i>Facebook Pixel</a>
						</li>
						<li> <a href="{{ url('setting-biaya') }}"><i class="bx bx-money"></i>Biaya</a>
						</li>
						<li> <a href="{{ url('setting-rekening') }}"><i class="bx bx-credit-card-front"></i>Rekening</a>
						</li>
					</ul>
				</li>
				@if (session()->get('levelAdmin') == '0')
				<li>
					<a href="{{ url('galeri') }}">
